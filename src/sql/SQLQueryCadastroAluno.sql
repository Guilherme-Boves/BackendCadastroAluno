...
ALU_ST_GENERO VARCHAR(25) NULL CONSTRAINT ALU_CK_ALU_GENERO CHECK (ALU_ST_GENERO = 'Masculino' OR ALU_ST_GENERO = 'Feminino'),
...
CREATE PROCEDURE SP_S_ALU_ALUNO 
--@IDADE_PESSOA INT
AS
...
--SELECT dbo.FN_IDADE(@IDADE_PESSOA) AS 'Total de alunos com a idade informada'
GO
